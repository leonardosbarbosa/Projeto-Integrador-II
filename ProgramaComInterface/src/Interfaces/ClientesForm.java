...
public class ClientesForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/trash.png"))); // NOI18N
        ...
        jButtonAlterar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/floppy-disk.png"))); // NOI18N
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        try {
            ...
            PreparedStatement pst = conecta.conn.prepareStatement("DELETE FROM clientes where cpf = ?");
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        try {
            // TODO add your handling code here:
            PreparedStatement pst = conecta.conn.prepareStatement("UPDATE clientes set fixo =?, celular =?, email =?, rua =?, bairro = ?, uf =?, cep =?, cidade =? "
                    + "where cpf =?");
